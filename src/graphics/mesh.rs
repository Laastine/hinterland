  ...
  mesh.iter()
    .map(|el| {
      ...
      let y_skew = match orientation {
        ...
        Some(Orientation::Left) => Angle::tan(Deg(63.0)),
        Some(Orientation::Right) => Angle::tan(Deg(-61.0)),
        _ => 0.0,
      };
      ...
      let translate = match orientation {
        ...
        Some(Orientation::Left) => Vector2::<f32>::new(55.0, -5.0),
        Some(Orientation::Right) => Vector2::<f32>::new(-58.0, -7.0),
